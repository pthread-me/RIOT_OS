...
static const struct schc_coap_rule_t coap_get_response = {
    6,6,6,
	{
		{COAP_V,    1, 2, 1,    BI, {COAP_V1},              &mo_equal,      NOTSENT},
		{COAP_T,    2, 2, 1,    BI, {CT_CON, CT_NON},       &mo_matchmap,   MAPPINGSENT},
		{COAP_TKL,  1, 4, 1,    BI, {1},                    &mo_equal,      NOTSENT},
        {COAP_C,    1, 8, 1,    BI, {CC_CONTENT},           &mo_equal,      NOTSENT},
        {COAP_MID,  1, 16, 1,   BI, {0},                    &mo_ignore,     VALUESENT},
        {COAP_TKN,  16, 8,  1,  BI, {0x00, 0x01, 0x02, 0x03,
                                     0x04, 0x05, 0x06, 0x07,
                                     0x08, 0x09, 0x0A, 0x0B,
...
static const struct schc_coap_rule_t coap_ack = {
    5,5,5,
	{
		{COAP_V,    1, 2, 1,    BI, {COAP_V1},          &mo_equal,      NOTSENT},
		{COAP_T,    1, 2, 1,    BI, {CT_ACK},           &mo_equal,      NOTSENT},
		{COAP_TKL,  1, 4, 1,    BI, {0},                &mo_equal,      NOTSENT},
        {COAP_C,    1, 8, 1,    BI, {CC_EMPTY},         &mo_equal,      NOTSENT},
        {COAP_MID,  1, 16, 1,   BI, {0},                &mo_ignore,     VALUESENT},
